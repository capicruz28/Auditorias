...
namespace AppPFashions.ViewModels
{
    public class LoginViewModel : INotifyPropertyChanged
    {
        ...
        //        IFolder rootFolder = await FileSystem.Current.GetFolderFromPathAsync("/storage/emulated/0/Fotos/");
        //        ExistenceCheckResult folderexist = await rootFolder.CheckExistsAsync(VariableGlobal.ctraba);
        //        if (folderexist == ExistenceCheckResult.FileExists)
        //        {
        //            IFile file = await rootFolder.GetFileAsync(VariableGlobal.ctraba + ".bmp");
        //            await file.DeleteAsync();
        //        }

        //        string rutapdf = "ftp://192.168.2.55:22/" + VariableGlobal.ctraba + ".bmp";
        //        downloader.DownloadFile(rutapdf, "Fotos");
